...
private:
  enum eAorT { kAdcHigh, kTdc, kAdcLow, kTdc2, kAorT };
...
public:
  ...
  Bool_t   GetTime2(Int_t cid, Int_t plid, Int_t seg,
		    Int_t ud, Int_t tdc, Double_t &time) const;
...
private:
  ...
  HodoTParam* GetT2map(Int_t cid, Int_t plid, Int_t seg, Int_t ud) const;  
