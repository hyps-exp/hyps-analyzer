...
struct Event
{
  ...
  Double_t vtx_SdcIn[MaxHits];
  Double_t vty_SdcIn[MaxHits];
  Double_t vtz_SdcIn[MaxHits];
  Double_t cdist_SdcIn[MaxHits];
  ...
  Double_t xtofSdcOut[MaxHits];
  Double_t ytofSdcOut[MaxHits];
...
ProcessingNormal()
{
  ...
  */
  ...
  for(Int_t it=0; it<ntSdcIn; ++it){
    ...
    TVector3 xkp(x0,y0,0);
    TVector3 dkp(u0,v0,1);
    TVector3 xG(0,0,0);//beam axis is assumed to be center
    TVector3 dG(0,0,1);
    Double_t cdistSdcIn;
    TVector3 vertex_SdcIn=Kinematics::VertexPoint(xG,xkp,dG,dkp,cdistSdcIn);
    HF1(11, Double_t(nh));
    HF1(12, chisqr);
    HF1(14, x0); HF1(15, y0);
    HF1(16, u0); HF1(17, v0);
    ...
    event.u0SdcIn[it] = u0;
    event.v0SdcIn[it] = v0;
    event.vtx_SdcIn[it] =vertex_SdcIn.x();
    event.vty_SdcIn[it] =vertex_SdcIn.y();
    event.vtz_SdcIn[it] =vertex_SdcIn.z();
    event.cdist_SdcIn[it] =cdistSdcIn;
  ...
  for(Int_t it=0; it<ntSdcOut; ++it){
    ...
    event.xtofSdcOut[it] = xtof;
    event.ytofSdcOut[it] = ytof;
    for(Int_t ih=0; ih<nh; ++ih){
      const auto& hit = track->GetHit(ih);
      Int_t layerId = hit->GetLayer();
...
ConfMan::InitializeHistograms()
{
  ...
  HB2(50010, "#Delta E - E (w/o PiID)", 100, 0., 200., 100, 0, 10);
  HB2(50011, "#Delta E - E (w/ PiID)", 100, 0., 200., 100, 0, 10);
  HB2(50012, "#Delta E - E", 100, 0., 200., 100, 0, 10);
  ...
  tree->Branch("vtx_SdcIn",   event.vtx_SdcIn,   "vtx_SdcIn[ntSdcIn]/D");
  tree->Branch("vty_SdcIn",   event.vty_SdcIn,   "vty_SdcIn[ntSdcIn]/D");
  tree->Branch("vtz_SdcIn",   event.vtz_SdcIn,   "vtz_SdcIn[ntSdcIn]/D");
  tree->Branch("cdist_SdcIn",   event.cdist_SdcIn,   "cdist_SdcIn[ntSdcIn]/D");
  ...
  tree->Branch("Total_dEphi_p",     event.Total_dEphi_p,     "Total_dEphi_p[nP_CFT]/D");
  tree->Branch("Total_dEuv_p",      event.Total_dEuv_p,      "Total_dEuv_p[nP_CFT]/D");
  tree->Branch("Total_dE_max_p",    event.Total_dE_max_p,    "Total_dE_max_p[nP_CFT]/D");
  tree->Branch("Total_dEphi_max_p", event.Total_dEphi_max_p, "Total_dEphi_max_p[nP_CFT]/D");
  tree->Branch("Total_dEuv_max_p",  event.Total_dEuv_max_p,  "Total_dEuv_max_p[nP_CFT]/D");
  ...
  tree->Branch("Total_dEphi_pi",     event.Total_dEphi_pi,     "Total_dEphi_pi[nPi_CFT]/D");
  tree->Branch("Total_dEuv_pi",      event.Total_dEuv_pi,      "Total_dEuv_pi[nPi_CFT]/D");
  tree->Branch("Total_dE_max_pi",    event.Total_dE_max_pi,    "Total_dE_max_pi[nPi_CFT]/D");
  tree->Branch("Total_dEphi_max_pi", event.Total_dEphi_max_pi, "Total_dEphi_max_pi[nPi_CFT]/D");
  tree->Branch("Total_dEuv_max_pi",  event.Total_dEuv_max_pi,  "Total_dEuv_max_pi[nPi_CFT]/D");
  ...
  tree->Branch("Total_dEphi_bgop",     event.Total_dEphi_bgop,     "Total_dEphi_bgop[nBGOP_CFT]/D");
  tree->Branch("Total_dEuv_bgop",      event.Total_dEuv_bgop,      "Total_dEuv_bgop[nBGOP_CFT]/D");
  tree->Branch("Total_dE_max_bgop",    event.Total_dE_max_bgop,    "Total_dE_max_bgop[nBGOP_CFT]/D");
  tree->Branch("Total_dEphi_max_bgop", event.Total_dEphi_max_bgop, "Total_dEphi_max_bgop[nBGOP_CFT]/D");
  tree->Branch("Total_dEuv_max_bgop",  event.Total_dEuv_max_bgop,  "Total_dEuv_max_bgop[nBGOP_CFT]/D");
  ...
  tree->Branch("Total_dEphi_hyps",     event.Total_dEphi_hyps,     "Total_dEphi_hyps[nHYPS_CFT]/D");
  tree->Branch("Total_dEuv_hyps",      event.Total_dEuv_hyps,      "Total_dEuv_hyps[nHYPS_CFT]/D");
  tree->Branch("Total_dE_max_hyps",    event.Total_dE_max_hyps,    "Total_dE_max_hyps[nHYPS_CFT]/D");
  tree->Branch("Total_dEphi_max_hyps", event.Total_dEphi_max_hyps, "Total_dEphi_max_hyps[nHYPS_CFT]/D");
  tree->Branch("Total_dEuv_max_hyps",  event.Total_dEuv_max_hyps,  "Total_dEuv_max_hyps[nHYPS_CFT]/D");
